...
if (ENVIRONMENT_IS_NODE) {
  ...
  var minVersion = 120000;
  if (numericVersion < 120000) {
    throw new Error('This emscripten-generated code requires node v12.0.0 (detected v' + nodeVersion + ')');
  }
...
var wasmBinaryFile;
  wasmBinaryFile = 'em_random_gen.wasm';
...
function sendDataToUI(audioContext,audioWorkletNode) { audioContext = emscriptenGetAudioObject(audioContext); audioWorkletNode = emscriptenGetAudioObject(audioWorkletNode); window.setWorklet(audioContext, audioWorkletNode); }
...
// end include: preamble.js
  ...
  function _emscripten_start_wasm_audio_worklet_thread_async(contextHandle, stackLowestAddress, stackSize, callback, userData) {
      ...
      audioWorklet.addModule('em_random_gen.aw.js').then(() => {
...
var ___start_em_js = Module['___start_em_js'] = 65716;
var ___stop_em_js = Module['___stop_em_js'] = 65979;
